...
Nothing - adj profit, runtime, vote counts/average, prop_profit
...
## Q3: Sentiment Analysis by Subgenre
...
horror_new2_1 <- horror_new2 |>
  ...
  mutate(profit = case_when(adj_profit2020 < 0 ~ "Unprofitable",
                            adj_profit2020 >= 0 & adj_profit2020 < adj_budget2020 ~ "Profitable",
                            adj_profit2020 >= adj_budget2020 ~ "Very Profitable")) |>
  mutate(profit = as.factor(profit, levels = c("Very Profitable", "Profitable", "Unprofitable")),
         genre_names = as.factor(genre_names, levels = c("Horror", "Action", "Science Fiction", "Drama", "Thriller", "Mystery")))
```
